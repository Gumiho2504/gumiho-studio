  ...
  <div style="padding-top:90px;min-height:100vh;">
    <div style="max-width:900px;margin:0 auto;padding:3rem 1.5rem 6rem;">
      ...
      <div style="text-align:center;margin-bottom:3.5rem;">
        <p class="font-rajdhani" style="color:#b04aff;font-size:.85rem;font-weight:700;letter-spacing:.2em;text-transform:uppercase;margin-bottom:.5rem;">✦ Get In Touch</p>
        <h1 class="font-cinzel glow-purple" style="font-size:clamp(1.6rem,4vw,2.5rem);font-weight:700;margin-bottom:.75rem;">Contact Us</h1>
        <div style="width:60px;height:3px;background:linear-gradient(90deg,#b04aff,#00d4ff);border-radius:2px;box-shadow:0 0 12px #b04aff;margin:0 auto 1.25rem;" />
        <p style="color:#8a80aa;font-size:.95rem;">Have a project idea? Let's collaborate and create something magical.</p>
      </div>
      ...
      <div class="contact-grid">
        ...
        <div class="border-glow" style="background:#0d0d1f;border-radius:20px;padding:2rem;">
          ...
          <div v-else>
            ...
            <button
              ...
              @click="submit"
            >
              <span v-if="sending" style="width:16px;height:16px;border:2px solid rgba(255,255,255,.3);border-top-color:white;border-radius:50%;display:inline-block;" class="animate-spin-fast" />
              <span v-else>✦</span>
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
          ...
          >
            <div style="font-size:1.5rem;flex-shrink:0;background:rgba(176,74,255,.1);width:44px;height:44px;border-radius:10px;display:flex;align-items:center;justify-content:center;">
              {{ info.icon }}
            </div>
            <div>
              <div style="color:#8a80aa;font-size:.75rem;font-family:'Rajdhani',sans-serif;font-weight:700;letter-spacing:.1em;text-transform:uppercase;">{{ info.label }}</div>
          ...
          <div style="background:#0d0d1f;border:1px solid rgba(176,74,255,.15);border-radius:14px;padding:1.2rem;">
            <div style="color:#8a80aa;font-size:.75rem;font-family:'Rajdhani',sans-serif;font-weight:700;letter-spacing:.1em;text-transform:uppercase;margin-bottom:1rem;">
              Follow Us
            </div>
...
const contactInfo = [
  ...
  { icon: '📧', label: 'Email',         val: 'hello@gumiho.studio'   },
  { icon: '💬', label: 'Telegram',      val: '@GumihoStudio'         },
